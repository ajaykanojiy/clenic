    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          <a href="<?php echo base_url('dashboard') ?>">
            ...
            <span class="pull-right-container">
              ...
              <!-- <i class="fa fa-angle-left pull-right"></i> -->
                ...
                <li class="treeview">
                            <a href="#">
                                <i class="fa fa-user"></i> <span>Patient Mangment</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('patient/create'); ?>"><i class="fa fa-circle-o"></i> Patient Form</a></li>
        ...
        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('doctor'); ?>"><i class="fa fa-circle-o"></i> Add Doctor</a></li>
        ...
        <li class="active">
          ...
          <a href="<?php echo base_url('staff') ?>">
            ...
            <i class="fa fa-th"></i> <span>Staff Create</span>
        ...
        <li class="active">
          ...
          <a href="<?php echo base_url('service') ?>">
            ...
            <i class="fa fa-th"></i> <span>Service Create</span>
